...
namespace Colors {
    ...
    inline const std::unordered_map<std::string, SDL_Color> NameMap = {
        ...
        {"white", White}, {"yellow", Yellow}, {"cyan", Cyan}, {"magenta", Magenta},
        {"orange", Orange}, {"purple", Purple}, {"pink", Pink}, {"brown", Brown},
        {"gray", Gray}, {"gray20", Gray20}, {"gray50", Gray50}, {"gray80", Gray80},
        {"darkgray", DarkGray}, {"lightgray", LightGray},
        // Chill / Lofi
        {"lofi_beige", LofiBeige}, {"lofi_brown", LofiBrown},
        {"lofi_mint", LofiMint}, {"lofi_dustypink", LofiDustyPink},
        // Pastel
        {"pastel_peach", PastelPeach}, {"pastel_lilac", PastelLilac},
        {"pastel_aqua", PastelAqua}, {"pastel_lemon", PastelLemon},
        {"pastel_green", PastelGreen}, {"pastel_sky", PastelSky},
        // Đêm
        {"night_sky", NightSky}, {"twilight_purple", TwilightPurple},
        {"moon_gray", MoonGray}, {"star_yellow", StarYellow},
        {"deepsea_blue", DeepSeaBlue},
        // Vaporwave / Retro
        {"vapor_pink", VaporPink}, {"vapor_teal", VaporTeal},
        {"vapor_purple", VaporPurple}, {"vapor_neongreen", VaporNeonGreen},
        {"vapor_orange", VaporOrange},
        // Cyberpunk / Neon
        {"neon_magenta", NeonMagenta}, {"neon_cyan", NeonCyan},
        {"neon_yellow", NeonYellow}, {"neon_orange", NeonOrange},
        {"neon_green", NeonGreen},
        // Earth Tones
        {"earth_sand", EarthSand}, {"earth_olive", EarthOlive},
        {"earth_terracotta", EarthTerracotta}, {"earth_forest", EarthForest},
        {"earth_clay", EarthClay},
        // Accent
        {"accent_hotpink", AccentHotPink}, {"accent_iceblue", AccentIceBlue},
        {"accent_mint", AccentMint}, {"shadow_dark", ShadowDark},
        // Transparent
        {"transparent", Transparent}, {"transp_white", TranspWhite},
        {"transp_red", TranspRed}, {"transp_green", TranspGreen},
        {"transp_blue", TranspBlue}
    };

    // Lấy màu theo tên (không phân biệt hoa thường); ném exception nếu không tìm thấy.
